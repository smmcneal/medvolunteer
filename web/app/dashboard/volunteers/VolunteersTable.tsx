...
type SortKey = 'name' | 'category' | 'status' | 'onboarding_pct'
              ...
              return (
                <tr key={v.id} style={{
                  ...
                  <td style={{ padding: '13px 24px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                      <div style={{
                        ...
                        fontSize: '11px', fontWeight: 700, color: catStyle.text, flexShrink: 0,
                      }}>
                        {initials(v.first_name, v.last_name)}
                      </div>
                      <div>
                        <Link href={`/dashboard/volunteers/${v.id}`} style={{
                    ...
                    {v.locations.length === 0
                      ...
                      : v.locations.map(l => (
                          <span key={l} style={{
                            ...
                            padding: '2px 7px', borderRadius: '5px', marginRight: '4px',
                          }}>{l}</span>
                        ))
                    }
                  </td>
                  ...
                  <td style={{ padding: '13px 24px' }}>
                    {v.total_stages === 0 ? (
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        <div style={{
                          flex: 1, minWidth: '80px', height: '5px',
                          borderRadius: '3px', background: '#f3f4f6', overflow: 'hidden',
                        }}>
                          <div style={{
                            height: '100%', borderRadius: '3px',
                            background: v.onboarding_pct === 100 ? '#22c55e' : '#1B2A4A',
                            width: `${v.onboarding_pct}%`,
                            transition: 'width 0.3s ease',
                          }} />
                        </div>
                        <span style={{ fontSize: '12px', color: '#6b7280', whiteSpace: 'nowrap' }}>
                          {v.completed_stages}/{v.total_stages}
                        </span>
                      </div>
                    )}
                  </td>
                  ...
                  <td style={{ padding: '13px 16px', textAlign: 'right' }}>
                    <Link href={`/dashboard/volunteers/${v.id}`} style={{ color: '#d1d5db', textDecoration: 'none', fontSize: '16px' }}>
                      →
                    </Link>
                  </td>
                </tr>
